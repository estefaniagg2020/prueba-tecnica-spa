<template>
  <Modal :is-open="isOpen" @close="$emit('close')">
    ...
    <form @submit.prevent="editor.save" class="space-y-4">
      <div>
      ...
      <div>
        ...
        <div class="grid grid-cols-2 gap-2">
          <button 
            ...
            :class="editor.form.type === type.value ? type.activeClass : 'border-transparent bg-gray-50 text-gray-500 hover:bg-gray-100'"
          >
      ...
      <div v-if="editor.error" class="text-red-500 text-sm bg-red-50 p-2 rounded-lg">
          {{ editor.error }}
      </div>
      ...
      <div class="pt-4 flex justify-end gap-3 border-t border-gray-100">
        ...
        <BaseButton variant="ghost" type="button" @click="$emit('close')">{{ editor.labels.BTN_CANCEL }}</BaseButton>
